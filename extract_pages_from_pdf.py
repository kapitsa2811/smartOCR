...
def from_pdf_to_pil_generator(file_path, temp_folder=TEMP_IMG_FOLDER_FROM_PDF, thread_name=None):
    file_path="C:\\Users\Lenovo\PycharmProjects\IntelligentOCR\images\\"
    ...
    if 0:
        ...
        while True:
            thread_name="dummy"
            print("\n\t file_path=",file_path,"\t\t ",os.path.join(temp_folder, "temp-{}".format(thread_name)))
