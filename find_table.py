...
def crop_wide(pdf_name,pil_image, boxes):
    """
    ...
    if not boxes == []:
        ...
        for indx,box in enumerate(boxes):
            ...
            temp=pil_image.crop(tuple((0, int(box[0]), im_width, int(box[2]))))
            # temp.show()
            temp.save("C:\\Users\Lenovo\PycharmProjects\IntelligentOCR\crops\\"+pdf_name+"_"+str(indx)+".jpg")
        ...
        print('Creating image from cropped text slices...')
    ...
    #cropped_tables.save("C:\\Users\Lenovo\PycharmProjects\IntelligentOCR\crops\\1.jpg")

    return cropped_tables, cropped_text


def extract_tables_and_text(pdf_name,pil_image, inference_graph_path):
    """
    ...
    (cropped_tables, cropped_text) = crop_wide(pdf_name,pil_image, best_boxes)
    return cropped_tables, cropped_text
